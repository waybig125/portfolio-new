...
const data = [
  ...
  },
  {
    ...
    about:
      "I was asked to complete a website for a jewellery e-store. Although, the website was started by the owner but due to lack of experience, the designing was awful. Moreover, she had installed a lot of plugins that were slowing down the website a lot. I designed the website locally on my laptop and after completing it, the next difficulty was waiting for me. The hosting, the owner had bought had limited capacities for uploading and related things. So, I had no choice but to ask the owner to update the hosting which she readily did. the next issue, I faced was importing the website and finding a suitable plugin for it. It took me 2-3 days to find the right plugin as (I said earlier), the website was full of plugins which were making it heavier in size. Finally, I was able to find the right plugin. The next thing, I was asked to do was to translate the website into Czech langugage , as I didn't know Czech language, I had to use Google Translate and a number of other tools to first translate the content and then to fully integrate that content, I had to study the wordpress and related plugins' source code from scratch to actually modify it in order to integrate the translated content and then finally, I was able to complete the task. Hence, I had completed the website.",
